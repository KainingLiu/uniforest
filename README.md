...
- Task2 两轮 Tag6：目标距离 425 mm、横向 0 mm、航向 180°；容差 ±10 mm/±10 mm/±3°，无精对准，合格后停车确认 4 个新帧。平移最低期望速度 80 mm/s，前后/横向上限 260/200 mm/s。
...
- 两轮 Task2 暂时跳过 Tag3 对准及随后的横移；转到 -90° 后直接以 400 mm/s 前进 300 mm，再以 300 mm/s 向前顶墙。
...
部署状态：2026-09-23 已定向上传最新 Task2 路线、Tag6 ±10 mm 且取消精对准、最低平移 80 mm/s，以及常规转向前馈 120°/s；树莓派离线检查通过，未由助手启动实机动作。2026-09-24 已整理文档，待树莓派连接后同步。A 板前臂偏置和 Grap1/2 行程变更需另行通过 CLion 烧录。
